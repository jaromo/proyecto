...
if(params$cliente=="LAICA") {
  cat="REFRESCOS EN POLVO"
  marcacliente=""
}
...
if(params$cliente%in%c("Claro TV","Claro Movil","HUAWEI","IGT","LAICA")){
...
if(params$cliente%in%c("BETO")){
  target="Personas 18-59 B-M y Personas 30-44 AM-M" 
}
...
if(params$cliente%in%c("Claro Movil","IGT","BETO")){
  ...
  data=data[-(which(data$Anunciante=="FINANCIA CREDIT INT")),]
  data$Anunciante=as.factor(data$Anunciante)
}
if(params$cliente%in%c("Claro TV","SKY","Fidelitas","FIFCO Agua","FIFCO Cerveza","FIFCO Energizantes","HUAWEI","LANCO","Tio Pelon Arroz","Tio Pelon Frijoles","Tio Pelon Salsa Inglesa","UCIMED","LAICA")){
