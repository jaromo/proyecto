...
cat("La inversión registrada en ",p$Categoría[1]," de ",params$mes_in," a ",params$mes_fin," ",params$`ano`,", se divide en ",temp)
```
...
cat("La inversión registrada en ",p$Categoría[2]," de ",params$mes_in," a ",params$mes_fin," ",params$`ano`,", se divide en ",temp)
```
...
cat("La inversión registrada en ",p$Categoría[3]," de ",params$mes_in," a ",params$mes_fin," ",params$`ano`,", se divide en ",temp)
```
...
cat("La inversión registrada en ",p$Categoría[4]," de ",params$mes_in," a ",params$mes_fin," ",params$`ano`,", se divide en ",temp)
```
...
cat("La inversión registrada en ",p$Categoría[5]," de ",params$mes_in," a ",params$mes_fin," ",params$`ano`,", se divide en ",temp)
```
