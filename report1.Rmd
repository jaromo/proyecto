...
if(params$cliente%in%c("BANCO POPULAR","BANCO DE CR","COOPENAE BANCA")){
  cat="BANCA"
...
if(params$cliente%in%c("BANCO DE CR","BANCO POPULAR","ROSTIPOLLOS","PIZZA HUT","COOPENAE BANCA")){
...
if(params$cliente%in%c("BANCO POPULAR","INS","BANCO DE CR","COOPENAE BANCA")){
