...
if(params$cliente=="FIFCO Jugos") {
  ...
  cat2=c("JUGOS","REFRESCOS","GASEOSOS CRISTALIN","GASEOSOS COLAS","GASEOSOS SABORES","REFRESCOS DE TE","BEBIDAS NATURALES")}
...
data$Categoría[data$Categoría%in%c("JUGOS","REFRESCOS")]="JUGOS Y REFRESCOS"
